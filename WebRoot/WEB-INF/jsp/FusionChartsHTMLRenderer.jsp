...
%> 
			...
			width="<%= chartWidth%>" height="<%= chartHeight%>" id="<%= chartId%>" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-1" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/FusionChartsHTMLRenderer.jsp">
