...
%>
			...
			%>
			<div id='<%=chartId %>Div' align='center' data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-2" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/FusionChartsRenderer.jsp">Chart.</div>
			<% } %>
