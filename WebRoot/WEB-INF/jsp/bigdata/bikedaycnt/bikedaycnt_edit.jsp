...
<body class="no-skin" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-4" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/bigdata/bikedaycnt/bikedaycnt_edit.jsp">
<!-- /section:basics/navbar.layout -->
<div class="main-container" id="main-container" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-4" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/bigdata/bikedaycnt/bikedaycnt_edit.jsp">
		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="bikedaycnt/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="BIKEDAYCNT_ID" id="BIKEDAYCNT_ID" value="${pd.BIKEDAYCNT_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="number" name="AVERIDETM" id="AVERIDETM" value="${pd.AVERIDETM}" maxlength="32" placeholder="这里输入备注4" title="备注4" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注5:</td>
								<td><input class="span10 date-picker" name="DATE" id="DATE" value="${pd.DATE}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="备注5" title="备注5" style="width:98%;"/></td>
							</tr>
							<tr>
