...
<body class="no-skin" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/bike/bikeday/bikeday_edit.jsp">
<!-- /section:basics/navbar.layout -->
<div class="main-container" id="main-container" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/bike/bikeday/bikeday_edit.jsp">
		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="bikeday/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="BIKEDAY_ID" id="BIKEDAY_ID" value="${pd.BIKEDAY_ID}"/>
