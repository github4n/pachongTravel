...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-16" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/error.jsp"> 
  <div class="dialog" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-16" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/error.jsp"> 
    <h1>应用程序异常</h1> 
