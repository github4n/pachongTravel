...
<body class="no-skin" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-41" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/otatour/touragent/touragent_edit.jsp">
<!-- /section:basics/navbar.layout -->
<div class="main-container" id="main-container" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-41" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/otatour/touragent/touragent_edit.jsp">
		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="touragent/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="TOURAGENT_ID" id="TOURAGENT_ID" value="${pd.TOURAGENT_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input class="span10 date-picker" name="TICKNAME" id="TICKNAME" value="${pd.TICKNAME}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="备注2" title="备注2" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注3:</td>
								<td><input type="number" name="TICKID" id="TICKID" value="${pd.TICKID}" maxlength="32" placeholder="这里输入备注3" title="备注3" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="DATE" id="DATE" value="${pd.DATE}" maxlength="20" placeholder="这里输入备注6" title="备注6" style="width:98%;"/></td>
							</tr>
							<tr>
