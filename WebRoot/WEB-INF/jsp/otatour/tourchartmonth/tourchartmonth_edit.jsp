...
<body class="no-skin" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-45" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/otatour/tourchartmonth/tourchartmonth_edit.jsp">
<!-- /section:basics/navbar.layout -->
<div class="main-container" id="main-container" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-45" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/otatour/tourchartmonth/tourchartmonth_edit.jsp">
		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="tourchartmonth/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="TOURCHARTMONTH_ID" id="TOURCHARTMONTH_ID" value="${pd.TOURCHARTMONTH_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="DAY" id="DAY" value="${pd.DAY}" maxlength="20" placeholder="这里输入备注4" title="备注4" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注5:</td>
								<td><input type="text" name="MONTH" id="MONTH" value="${pd.MONTH}" maxlength="20" placeholder="这里输入备注5" title="备注5" style="width:98%;"/></td>
							</tr>
							<tr>
