...
<body class="no-skin" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-47" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/otatour/tourchartyear/tourchartyear_edit.jsp">
<!-- /section:basics/navbar.layout -->
<div class="main-container" id="main-container" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-47" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/otatour/tourchartyear/tourchartyear_edit.jsp">
		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="tourchartyear/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="TOURCHARTYEAR_ID" id="TOURCHARTYEAR_ID" value="${pd.TOURCHARTYEAR_ID}"/>
