...
<body class="no-skin" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-49" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/person/personactivity/personactivity_edit.jsp">
<!-- /section:basics/navbar.layout -->
<div class="main-container" id="main-container" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-49" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/person/personactivity/personactivity_edit.jsp">
		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="personactivity/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="PERSONACTIVITY_ID" id="PERSONACTIVITY_ID" value="${pd.PERSONACTIVITY_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="number" name="TOTALUSERNUM" id="TOTALUSERNUM" value="${pd.TOTALUSERNUM}" maxlength="32" placeholder="这里输入备注3" title="备注3" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注4:</td>
								<td><input type="number" name="NEWUSERNUM" id="NEWUSERNUM" value="${pd.NEWUSERNUM}" maxlength="32" placeholder="这里输入备注4" title="备注4" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">备注5:</td>
								<td><input type="number" name="ORDERNUM" id="ORDERNUM" value="${pd.ORDERNUM}" maxlength="32" placeholder="这里输入备注5" title="备注5" style="width:98%;"/></td>
							</tr>
							<tr>
