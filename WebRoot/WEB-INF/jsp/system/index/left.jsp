<div id="sidebar" class="sidebar responsive" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-80" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/system/index/left.jsp">
				...
				<ul class="nav nav-list">
					<li class="">
						<a href="main/index">
							<i class="menu-icon fa fa-user" style="vertical-align:middle"></i>
							<span class="menu-text">首页</span>
						</a>
						<b class="arrow"></b>
					</li>
					<c:forEach items="${menuList}" var="menu1" varStatus="id">
						<c:if test="${menu1.hasMenu && '1' == menu1.MENU_STATE}">
							<li class="open"  id="lm${menu1.MENU_ID }">
								<a style="cursor:pointer;" class="dropdown-toggle">
									<c:choose> 
										<c:when test="${id.index eq 9 }">
											<i class="menu-icon fa fa-tag" style="vertical-align:middle"></i>
										</c:when> 
										<c:when test="${id.index eq 10 }">
											<i class="menu-icon fa fa-book" style="vertical-align:middle"></i>
										</c:when> 
										<c:otherwise>
											<i class="menu-icon fa fa-user" style="vertical-align:middle"></i>
										</c:otherwise> 
