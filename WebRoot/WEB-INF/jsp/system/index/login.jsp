...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-81" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/system/index/login.jsp">
	<div style="width:100%;text-align: center;margin: 0 auto;position: absolute;" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-81" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/system/index/login.jsp">
		<!-- 登录 -->
		<div id="windows1">
		<div id="loginbox" >
			<form action="" method="post" name="loginForm" id="loginForm">
				...
				<div class="form-actions">
					<div style="width:86%;padding-left:8%;">
						...
						<div style="float: left;">
							<i><img style="height:26px;" src="static/login/yan.png" /></i>
						</div>
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="black"><span id="nameerr">Copyright © 上海昕鼎网络科技有限公司</span></font>
				</div>
			</div>
		</div>
		</div>
		...
		<div id="loginbox">
			...
			<div class="controls">
				<div class="main_input_box">
					<font color="white"><span id="nameerr">Copyright © 上海昕鼎网络科技有限公司</span></font>
				</div>
			</div>
		</div>
		</div>
