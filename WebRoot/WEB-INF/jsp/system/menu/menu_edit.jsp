...
<body class="no-skin" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-88" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/system/menu/menu_edit.jsp">

	<!-- /section:basics/navbar.layout -->
	<div class="main-container" id="main-container" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-88" data-genuitec-path="/ZHLY/WebRoot/WEB-INF/jsp/system/menu/menu_edit.jsp">
